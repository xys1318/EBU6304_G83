...
(function () {
    ...
    var css =
        ...
        ".feedback-toast{pointer-events:auto;background:var(--text-1,#1a1a1a);color:#fff;padding:12px 16px;border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.2);font:14px/1.4 Arial,Helvetica,sans-serif;animation:feedback-toast-in .25s ease;}" +
        ".feedback-toast.success{background:var(--success,#0d5c2e);}" +
        ".feedback-toast.error{background:var(--error,#8b1a1a);}" +
        ".feedback-toast.info{background:var(--primary,#003366);}" +
        ...
        "#" + BANNER_ID + ".success{background:#e8f5ee;color:var(--success,#155724);border-bottom:1px solid #c8e8d6;}" +
        "#" + BANNER_ID + ".error{background:#fdeeee;color:var(--error,#721c24);border-bottom:1px solid #f3d1d1;}" +
        "#" + BANNER_ID + ".info{background:var(--primary-soft,#cce5ff);color:var(--primary-strong,#004085);border-bottom:1px solid var(--border,#b8daff);}" +
